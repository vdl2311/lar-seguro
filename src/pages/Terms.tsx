  ...
  return (
    <div className="min-h-screen bg-warm-white font-sans text-text-dark">
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        >
          <h1 className="font-serif font-bold text-3xl sm:text-4xl mb-8 text-text-dark">Termos de Uso</h1>
          ...
          <div className="space-y-6 text-text-mid leading-relaxed font-light text-lg">
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">1. Objeto</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">4. Política de Compra e Garantia</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">5. Aceitação e Vinculação</h2>
            ...
            <div className="mt-12 p-6 bg-warm-white border border-border-custom rounded-2xl">
              <strong className="block text-text-dark mb-2">Canal de Atendimento Legal:</strong>
              E-mail: <a href="mailto:contato@larseguro.com.br" className="text-accent hover:underline font-medium">contato@larseguro.com.br</a>
            </div>
          </div>
        </motion.div>
      </div>
