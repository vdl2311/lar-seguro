  ...
  return (
    <div className="min-h-screen bg-warm-white font-sans text-text-dark">
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        <Link to="/" className="inline-flex items-center gap-2 text-accent font-medium mb-8 hover:underline">
        ...
        <motion.div 
          ...
          className="bg-cream rounded-3xl p-8 sm:p-12 shadow-sm border border-border-custom"
        >
          <h1 className="font-serif font-bold text-3xl sm:text-4xl mb-8 text-text-dark">Política de Privacidade</h1>
          
          <div className="space-y-6 text-text-mid leading-relaxed font-light text-lg">
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">1. Coleta de Dados Pessoais</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">2. Uso das Informações</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">3. Proteção e Segurança</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">4. Compartilhamento de Dados</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">5. Direitos do Usuário</h2>
            ...
            <h2 className="text-xl font-bold text-text-dark mt-8 mb-4 font-serif">6. Alterações da Política</h2>
            ...
            <div className="mt-12 p-6 bg-warm-white border border-border-custom rounded-2xl">
              <strong className="block text-text-dark mb-2">Contato Encarregado LGPD / Dúvidas:</strong>
              E-mail: <a href="mailto:contato@larseguro.com.br" className="text-accent font-medium hover:underline">contato@larseguro.com.br</a>
            </div>
          </div>
        </motion.div>
      </div>
